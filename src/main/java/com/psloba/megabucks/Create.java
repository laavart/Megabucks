...
public class Create {
    ...
    private void onSubmit() {
        ...
        if(check) {
            ...
            if(id != -1) {
                System.out.println("Primary Stage registration completed of player_" + id);
                try {
                    ...
                    if(AppData.database.searchTable("player_"+id)) AppData.database.executeUpdate("delete from player_" + id + ";");
                    else {
                        AppData.database.executeUpdate(
        ...
        } else System.out.println("Receiving False");
    }
}
